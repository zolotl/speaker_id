...
def get_true_and_predicted_labels_cnn(model, dataloader, dataset):
  model.eval()
  true_labels = []
  predicted_labels = []
  ...
  label_to_speaker = {v: k for k, v in dataset.speaker_to_label.items()}
...
true_speaker_labels, predicted_speaker_labels = get_true_and_predicted_labels_cnn(model, test_dataloader, test_dataset)
